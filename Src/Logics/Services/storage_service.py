...
class storage_service(abstract_sevice):
    ...
    def create_id_turns(self, id: uuid.UUID):
        ...
        storage_observer.raise_event(event_type.make_log(log_type.log_type_debug(), "получить обороты по номенклатуре",
    ...
    def create_reciepe_transactions(self, reciepe: reciepe_model):
        ...
        storage_observer.raise_event(event_type.make_log(log_type.log_type_debug(), "создать транзакции по рецепту",
    ...
    def create_id_turns_storage(self, nomenclature_id: uuid.UUID, storage_id: str):
        ...
        storage_observer.raise_event(
            event_type.make_log(log_type.log_type_debug(), "рейтинг номенклатуры по складам и айди",
    ...
    def create_blocked_turns(self) -> dict:
        ...
        self.__blocked = data
        storage_observer.raise_event(
            event_type.make_log(log_type.log_type_debug(), "получить обооты до периода блокировки",
